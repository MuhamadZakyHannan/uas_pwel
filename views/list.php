...
<main class="container my-4">
  <div class="row mb-4 align-items-center">
    <div class="col">
      <h1 class="fs-3 mb-0" id="ebook-list-title">Total eBooks: <?= $totalEbook ?></h1>
    </div>
  </div>

  <div class="content-wrapper">
    <div id="ebook-list-container">
      <?php if ($totalEbook === 0): ?>
      ...
      <?php if ($totalEbook > 0 && $totalPage > 1): ?>
        <nav class="my-5">
          <ul class="pagination justify-content-center">
            <li class="page-item <?= $activePage <= 1 ? 'disabled' : '' ?>"><a class="page-link" href="?action=list&page=<?= $activePage - 1 ?>">Previous</a></li>
            <?php for ($page = 1; $page <= $totalPage; $page++): ?>
              <li class="page-item <?= $page == $activePage ? 'active' : '' ?>"><a class="page-link" href="?action=list&page=<?= $page ?>"><?= $page ?></a></li>
            <?php endfor; ?>
            <li class="page-item <?= $activePage >= $totalPage ? 'disabled' : '' ?>"><a class="page-link" href="?action=list&page=<?= $activePage + 1 ?>">Next</a></li>
          </ul>
        </nav>
      <?php endif; ?>
    </div>
